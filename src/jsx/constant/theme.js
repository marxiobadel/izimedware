...
export const DEVNAME = 'IziSolutions';
...
export const calculateAge = (birthdate) => {
    ...
    // Vérifier si l'anniversaire est encore à venir cette année
...
export const removeStringAndSpace = (text, stringToRemove) => {
    ...
    // Remove all spaces and occurrences of the specified string
    const regex = new RegExp(stringToRemove, "gi"); // Case insensitive removal
...
export const IMAGES = {
    ...
    Avatar4: require('../../images/avatar/4.jpg'),
    Avatar5: require('../../images/avatar/5.jpg'),
    profile1: require('../../images/profile/pic1.jpg'),

    User1: require('../../images/users/1.png'),
    User2: require('../../images/users/2.png'),
    User3: require('../../images/users/3.png'),
    User4: require('../../images/users/4.png'),
    User5: require('../../images/users/5.png'),

    User6: require('../../images/users/6.png'),
    User7: require('../../images/users/7.png'),
    User8: require('../../images/users/8.png'),
    User9: require('../../images/users/9.png'),
    User10: require('../../images/users/10.png'),
    Userpng11: require('../../images/users/11.png'),
    Userpng12: require('../../images/users/12.png'),
    Userpng13: require('../../images/users/13.png'),
    Userpng14: require('../../images/users/14.png'),
    Userpng15: require('../../images/users/15.png'),
    Userpng16: require('../../images/users/16.png'),
    Userpng17: require('../../images/users/17.png'),
    Userpng18: require('../../images/users/18.png'),
    Userpng19: require('../../images/users/19.png'),

    User11: require('../../images/users/1.jpg'),
    User12: require('../../images/users/2.jpg'),
    User13: require('../../images/users/3.jpg'),
    User14: require('../../images/users/4.jpg'),
    User15: require('../../images/users/5.jpg'),

    User16: require('../../images/users/6.jpg'),
    User17: require('../../images/users/7.jpg'),
    User18: require('../../images/users/8.jpg'),
    User19: require('../../images/users/9.jpg'),
    User20: require('../../images/users/10.jpg'),
    User21: require('../../images/users/11.jpg'),
    User22: require('../../images/users/12.jpg'),
    ...
    profileimg2: require('../../images/profile/2.png'),
    Bannerbg: require('../../images/bg.jpg'),
