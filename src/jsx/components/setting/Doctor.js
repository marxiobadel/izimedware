...
const Doctor = () => {
    ...
    const handleSubmit = () => {
        ...
        axiosInstance.post(`settings/doctor/update`,
            { cover: image },
    ...
    useEffect(() => {
        ...
        (() => {
            axiosInstance.get('settings/doctor/index', {signal: controller.signal})
                .then(function({data}) {
    ...
    return (
        <div className="card pb-0">
            <div className="card-header border-0 pb-0">
                <h4 className="card-title">Paramètres du personnel médical</h4>
            </div>
                    ...
                    <div className="col-12 col-sm-12 col-md-12">
                        ...
                        >
                            ...
                            <p className="text-gray-600">
                                Glissez-déposez la couverture du personnel, ou cliquez pour sélectionner
                            </p>
                        </div>
                        {previewImage && (
                            <div className="mt-4">
