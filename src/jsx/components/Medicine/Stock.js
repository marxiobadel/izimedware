...
const Stock = () => {
    ...
    const columns = useMemo(() => [
        ...
        {
            Header : 'Ravitaillé le',
            Footer : 'Ravitaillé le',
            accessor: 'date',
            Filter: ColumnFilter,
        },
        {
        ...
        <>
            <div className="form-head align-items-center d-flex mb-sm-4 mb-3">
                <div className="me-auto">
                    <h2 className="text-black font-w600">Stocks</h2>
                    <p className="mb-0">Liste des ravitaillements de médicaments</p>
                </div>
                <div>
                    <Link to={"#"} className="btn btn-primary me-3" onClick={() => setOpenModal(true)}>+ Nouveau stock</Link>
                </div>
            </div>
            <ToastContainer />
            <Row>
