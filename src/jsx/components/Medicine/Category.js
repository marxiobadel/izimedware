        ...
        <>
            <div className="form-head align-items-center d-flex mb-sm-4 mb-3">
                <div className="me-auto">
                    <h2 className="text-black font-w600">Catégories</h2>
                    <p className="mb-0">Liste des catégories de médicaments</p>
                </div>
                <div>
                    <Link to={"#"} className="btn btn-primary me-3" onClick={handleAdd}>+ Nouvelle catégorie</Link>
                </div>
            </div>
            <ToastContainer />
            <Row>
