...
const MedicalProcedure = () => {
    ...
    const [editingMedicalProcedure, setEditingMedicalProcedure] = useState(null);
    ...
    const handleEdit = (medicalProcedure) => {
        setEditingMedicalProcedure(medicalProcedure);
        setOpenModal(true);
    };

    const handleDelete = (medicalProcedure) => {
        Swal.fire({
            title:'Etes-vous sûr ?',
    ...
    const handleAdd = () => {
        setEditingMedicalProcedure(null);
        setOpenModal(true); 
    }
        ...
        <>
            <div className="form-head align-items-center d-flex mb-sm-4 mb-3">
                <div className="me-auto">
                    <h2 className="text-black font-w600">Actes médicaux</h2>
                    <p className="mb-0">Liste des actes médicaux</p>
                </div>
                <div>
                    <Link to={"#"} className="btn btn-primary me-3" onClick={handleAdd}>+ Nouvel acte médical</Link>
                </div>
            </div>
            <ToastContainer />
            <Row>
