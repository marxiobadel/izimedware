...
const ObservationModal = ({show, onHide, onSave, consultation}) => {
    ...
    const handleSubmit = (e) => {
        ...
        axiosInstance.request({
            method: 'POST',
            url: 'consultations/'+ consultation.id +'/observations',
            data: {...inputs, file},
            headers: {
        ...
        <Modal className="modal fade" backdrop={true} show={show} onHide={onHide} centered>
            <div className="modal-content">
                <div className="modal-header">
                    <h5 className="modal-title">Ajouter une observation</h5>
